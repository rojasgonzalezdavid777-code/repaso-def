    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.card}>
          <Text style={styles.title}>Programación básica</Text>
          <View style={styles.divider} />
          
          {/* Contenedor en blanco para meter el contenido de la clase 2 */}
          <View style={styles.vistaBlanca}>
            <Text style={styles.textBlanco}>Esta es tu nueva vista en blanco para la clase 2.</Text>
          </View>
